...
{
	/// <summary>
	/// Summary description for DataGridWithInlineDataBinding.
	/// </summary>
	public class DataGridWithInlineDataBinding : System.Web.UI.Page
	{
		protected System.Web.UI.WebControls.DataGrid CustomerDataGrid;
	
		private void Page_Load(object sender, System.EventArgs e)
		{
			CustomerDataGrid.DataSource = GetLargeDS().Tables[0].DefaultView;
