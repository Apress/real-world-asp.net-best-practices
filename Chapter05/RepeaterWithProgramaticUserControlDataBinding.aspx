...
<%@ Page language="c#" Codebehind="RepeaterWithProgramaticUserControlDataBinding.aspx.cs" AutoEventWireup="false" Inherits="ASPControls.RepeaterWithProgramaticUserControlDataBinding" %>
...
<asp:Repeater id=CustomerRepeater runat="server">
	...
	<ItemTemplate>
		...
		<uc1:Order id=MyOrderControl DataSource='<%Container.DataItem%>' runat="server"></uc1:Order>
		</tr>		
	</ItemTemplate>
	<FooterTemplate>
</table>
